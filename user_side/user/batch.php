...
<div class="container" style="margin-top: 3%; margin-bottom: 3%; background-color: gray;padding-bottom: 5%;padding-top: 5%;border-radius: 7px;">

	<div class="col-xs-offset-3">
		<form class="form-horizontal" enctype="multipart/form-data" method="post" action="get_batch.php" name="batch" id="batch">
			...
			<div class="form-group">
				<button class="btn btn-info col-xs-offset-1" name="search_batch" style="width: 50%;">Search</button>
			</div>
